...
echo -e $yellow" 17) Ezsploit "
echo -e $yellow" 18) dirspy "
...
then
clear
echo -e $red" Installing Ezsploit "
sleep 1
...
then
clear
echo -e $red" Installing dirspy "
sleep 1
sudo apt install python2
git clone https://github.com/koboi137/dirspy
cd dirspy
cd ~/
echo -e $red" T E R I N S T A L L "
...
sleep 1
git clone git clone https://github.com/rbsec/dnscan
cd dnscan/
pip install -r requirements.txt
cd ~/
echo -e $red" T E R I N S T A L L "
